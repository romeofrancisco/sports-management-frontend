 ...
 * Redirects to Google Docs for document editing
 */
const GoogleDocEditor = ({ documentId }) => {
  ...
  // Redirect to Google Docs when URL is ready
  useEffect(() => {
      ...
      <div className="flex h-[calc(100vh-64px)] flex-col items-center justify-center gap-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground max-w-md">
            To view or edit documents, you need to sign in with your Google account.
          </p>
        </div>
        <Button 
    ...
    return (
      <div className="flex h-[calc(100vh-64px)] items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground">Opening Google Docs...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-muted-foreground">Redirecting to Google Docs...</p>

    ...
    <DropdownMenu>
      ...
      >
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <span className="text-[11px] mt-1 font-medium">Dark</span>
                      {theme === "dark" && (
                        <div className="absolute -top-1 -right-1">
        ...
        <div className="px-2 pt-2 pb-4">
          ...
          >
            <LogOut className="mr-3 h-5 w-5 transition-all duration-300 group-hover:scale-110 group-hover:-translate-x-1" />

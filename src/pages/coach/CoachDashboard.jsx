  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/2 to-secondary/2">
      <div className="p-4 md:p-6 space-y-8">
        ...
        <div className="bg-gradient-to-r from-card via-secondary/8 to-primary/8 rounded-xl p-6 shadow-xl border-2 border-primary/20 transition-all duration-300 hover:shadow-2xl animate-in fade-in-50 duration-500 relative overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-6">
              ...
              <div className="border-l-2 border-primary/40 pl-6">
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent drop-shadow-sm">
              ...
              <div className="flex items-center gap-3 bg-card/80 backdrop-blur-md rounded-full px-4 py-2 border-2 border-secondary/30 shadow-lg">
                <div className="h-3 w-3 rounded-full bg-gradient-to-r from-emerald-400 to-emerald-500 animate-pulse shadow-sm"></div>
                <span className="text-sm font-semibold text-foreground">
                  Dashboard Active
                </span>
              </div>
              {/* Enhanced University Colors Indicator */}
              <div className="flex gap-2 items-center bg-card/80 backdrop-blur-md rounded-full px-3 py-2 border-2 border-primary/30 shadow-lg">
                <div className="w-4 h-4 rounded-full bg-gradient-to-br from-primary to-primary/80 shadow-md border border-white/30"></div>
                <div className="w-4 h-4 rounded-full bg-gradient-to-br from-secondary to-secondary/80 shadow-md border border-white/30"></div>

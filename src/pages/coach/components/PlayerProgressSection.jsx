    ...
    <Card className="bg-gradient-to-br from-card via-card to-card/95 shadow-xl border-2 border-primary/20 transition-all duration-300 hover:shadow-2xl hover:border-primary/30 relative overflow-hidden">
      ...
      <CardHeader className="pb-4 relative">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            </CardTitle>            <CardDescription className="text-muted-foreground font-medium">
              Recent improvement tracking and development insights
            </CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent>
        {playerProgress?.player_progress?.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">            {playerProgress.player_progress.map((player, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    </div>                    {/* Enhanced improvement progress bar */}
                    {improvementPercentage !== null && (
                      <div className="space-y-2">
          ...
          <div className="text-center py-16 relative">
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground font-medium max-w-sm mx-auto">
                Player performance data will appear here as training sessions
                are completed and metrics are recorded
              </p>
            </div>
          </div>
        )}

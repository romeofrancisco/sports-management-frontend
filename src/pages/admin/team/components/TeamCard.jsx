...
const TeamCard = ({ team, onView, onEdit, onDelete, onReactivate }) => {
  ...
  return (
    <Card
      className={`relative overflow-hidden border-2 rounded-xl transition-all duration-300 hover:shadow-lg group bg-card border-border shadow-sm hover:border-primary/30 ${
        !team.is_active ? "opacity-70 border-gray-300" : ""
      }`}
    >
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="relative">
              ...
              {/* Team status indicator - Updated to show active/inactive status */}
              <div
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {/* Team active/inactive status badge */}
                <Badge
              ...
              {/* Coach information - improved layout */}
                ...
                {hasHeadCoach && (
                  <div className="flex items-center gap-1 text-muted-foreground">
                    ...
                    <span className="font-medium truncate">
                      Head Coach:{" "}
                      {team.head_coach_name || team.head_coach?.full_name}
                    </span>
                  </div>
                )}
                {hasAssistantCoach && (
                  <div className="flex items-center gap-1 text-muted-foreground">
                    ...
                    <span className="font-medium truncate">
                      Assistant Coach:{" "}
                      {team.assistant_coach_name ||
                        team.assistant_coach?.full_name}
                    </span>
                  </div>
                )}
                {!hasAnyCoach && team.is_active && (

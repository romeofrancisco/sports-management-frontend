...
const CoachFilterBar = ({
  ...
  const hasActiveFilters =
    filter.search || filter.sport || filter.sex || filter.is_active === false;
  ...
  const handleStatusChange = (checked) => {
    setFilter((prev) => ({ ...prev, is_active: !!checked }));
  };
            ...
            >
              <DropdownMenuGroup className="px-1 mb-3">
                <div className="flex justify-between items-center px-1 text-sm my-2">
                  <label
                    htmlFor="coach-status-active"
                    className="flex items-center gap-2 cursor-pointer select-none"
                  >
                    <Checkbox
                      id="coach-status-active"
                ...
                <p className="px-1 text-xs text-muted-foreground">
                  Checked shows active coaches. Unchecked shows inactive
                  coaches.
                </p>
              </DropdownMenuGroup>
              <DropdownMenuSeparator />

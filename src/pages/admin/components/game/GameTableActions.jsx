  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {isScheduled && (
          <>
            {!lineup_status.home_ready || !lineup_status.away_ready ? (
              <DropdownMenuItem onClick={() => handleOpen("registerLineup")}>
                Register Lineup
              </DropdownMenuItem>
            ) : (
              <DropdownMenuItem onClick={() => handleOpen("updateLineup")}>
                Update Lineup
              </DropdownMenuItem>
            )}
            {lineup_status.home_ready && lineup_status.away_ready && (
            ...
            <DropdownMenuItem onClick={() => handleOpen("update")}>Edit</DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleOpen("delete")}>Delete</DropdownMenuItem>
          </>
        )}

        {/* In Progress Game Options */}
        {isInProgress && (
          <DropdownMenuItem onClick={goToGamePage}>Continue Game</DropdownMenuItem>
        )}
        ...
        {isPostponed && (
          <>
            <DropdownMenuItem onClick={() => handleOpen("update")}>Reschedule</DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleOpen("delete")}>Delete</DropdownMenuItem>
          </>
        )}
      </DropdownMenuContent>

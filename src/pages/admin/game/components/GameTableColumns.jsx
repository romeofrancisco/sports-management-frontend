    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="grid grid-cols-[3] grid-rows-2 items-center font-medium text-center">
          ...
          <span className="text-muted-foreground font-bold col-start-2 row-start-1 mx-4 md:mx-0 row-span-2">
            VS
          </span>
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-center">
          <div className="font-medium text-sm">{league?.name || "Practice"}</div>
          <div className="text-xs text-muted-foreground">
            {season?.name || season?.year || "Exibition Game"}
          </div>
        </div>
      );
    },

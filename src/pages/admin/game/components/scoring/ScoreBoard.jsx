          ...
          <div className="grid grid-cols-[1fr_auto_1fr] md:gap-4 items-center">
            ...
            <div className="flex items-center justify-end gap-3">
              <div className="hidden md:block text-right">
                ...
                >
                  {home_team?.abbreviation?.toUpperCase() ||
                    home_team?.name?.toUpperCase()}
                </div>
                <div className="text-xs text-muted-foreground">HOME</div>
              </div>
              <Avatar
                className="size-8 md:size-12 border-2 shadow-sm"
            ...
            <div className="flex items-center gap-2 md:gap-3 px-4 py-2">
              ...
              <div className="text-center">
                <div className="text-xs">{getPeriodLabel(scoring_type)}</div>
            ...
            <div className="flex items-center justify-start gap-3">
              ...
              <div className="hidden md:block text-left">
                ...
                >
                  {away_team?.abbreviation?.toUpperCase() ||

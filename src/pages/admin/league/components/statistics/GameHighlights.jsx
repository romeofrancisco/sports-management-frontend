...
const GameHighlights = ({ comprehensiveStats }) => {
  ...
  const hasData = isSetBased
    ? comprehensiveStats.highest_scoring_sets?.length > 0 ||
      comprehensiveStats.biggest_margin_sets?.length > 0
    : comprehensiveStats.highest_scoring_games?.length > 0 ||
      comprehensiveStats.biggest_margin_games?.length > 0;

  const emptyMessage = comprehensiveStats.detail || "No highlights available.";
        ...
        <Card className="border-2 border-primary/20 overflow-hidden">
          ...
          <CardContent>
            {hasData ? (
              ...
              <div
                className="text-center content-center py-12"

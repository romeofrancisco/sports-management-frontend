...
const ChatPage = () => {
  ...
  const selectedChat = teamChats.find(chat => chat.team_id.toString() === teamId) || 
        ...
        <div className="flex-1 p-4">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="h-[calc(100vh-6.5rem)] rounded-xl bg-card/50 backdrop-blur-sm border border-primary/10 shadow-lg">                <TeamChatList
                  teamChats={teamChats}
            ...
            <div className="lg:col-span-3">
              <div className="h-[calc(100vh-6.5rem)] rounded-xl bg-card/50 backdrop-blur-sm border border-secondary/10 shadow-lg overflow-hidden">

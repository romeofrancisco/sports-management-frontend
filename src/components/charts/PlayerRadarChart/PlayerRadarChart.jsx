...
const PlayerRadarChart = ({ 
    ...
    return (
      <div className={`w-full ${className} text-center pb-8`}>
        ...
        <p className="text-base max-w-md mx-auto text-muted-foreground">
          This player hasn't recorded performance data across different training categories yet. 
          Start tracking their progress in various training areas.
        </p>
      </div>
    );
  }
  ...
  const chartData = {
    ...
    datasets: [
      ...
      {
        label: "Improvement %",
        data: radarData.improvement_percentages.map(val => Math.max(0, 50 + val)), // Normalize to 0-100 scale
        ...
        callbacks: {
          label: function(context) {
            ...
            if (context.datasetIndex === 0) {
              ...
              return `Improvement: ${categoryData.average_improvement.toFixed(1)}%`;
            }
          },

...
const LeaguesEmptyState = ({ searchTerm }) => {
  return (
    <div className="text-center py-16 relative">
      ...
      <div className="relative">
        ...
        <p className="text-foreground font-bold text-lg mb-2">
          {searchTerm ? "No leagues found" : "No leagues found"}
        </p>
        <p className="text-muted-foreground font-medium max-w-sm mx-auto">
          {searchTerm
            ? "Try adjusting your search terms to find leagues"
            : "Create your first league to get started with league management"}
        </p>
      </div>
    </div>
  );
...
export default LeaguesEmptyState;

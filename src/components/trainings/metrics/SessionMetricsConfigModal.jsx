...
const SessionMetricsConfigModal = ({ 
  ...
  const handleSave = () => {
    ...
    toast.success("Session metrics configured", {
      description: `${selectedMetrics.length} metrics have been assigned to this session.`,
      richColors: true
    });
    onClose();
  };
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {session.date && (
              <span className="block mt-1 text-sm">Session Date: {session.date}</span>
            )}
          </DialogDescription>
        </DialogHeader>
